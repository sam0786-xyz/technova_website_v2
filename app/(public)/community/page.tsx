                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    <Tabs defaultValue={defaultTab} className="w-full">
                        <div className="flex justify-center mb-12">
                            <TabsList className="bg-white/[0.03] border border-white/10 p-1.5 rounded-2xl">
                                <TabsTrigger value="discussions" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400 rounded-xl px-6 py-3 text-base flex gap-2">
                                    <MessageSquare className="w-5 h-5" /> Discussions
                                </TabsTrigger>
                                <TabsTrigger value="showcase" className="data-[state=active]:bg-emerald-500/20 data-[state=active]:text-emerald-400 rounded-xl px-6 py-3 text-base flex gap-2">
                                    <Rocket className="w-5 h-5" /> Project Showcase
                                </TabsTrigger>
                                <TabsTrigger value="resources" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400 rounded-xl px-6 py-3 text-base flex gap-2">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                >
                                    <Tabs defaultValue="all" className="w-full">
                                        <TabsList className="mb-6 bg-white/[0.03] border border-white/10 p-1 rounded-xl w-full flex overflow-x-auto no-scrollbar justify-start sm:justify-center">
                                            <TabsTrigger value="all" className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400 rounded-lg gap-2 flex-shrink-0">
                                                <MessageSquare className="w-4 h-4" /> All
                                            </TabsTrigger>
                                            <TabsTrigger value="projects" className="data-[state=active]:bg-purple-500/20 data-[state=active]:text-purple-400 rounded-lg gap-2 flex-shrink-0">
                                                <Rocket className="w-4 h-4" /> Projects
                                            </TabsTrigger>
                                            <TabsTrigger value="hackathons" className="data-[state=active]:bg-emerald-500/20 data-[state=active]:text-emerald-400 rounded-lg gap-2 flex-shrink-0">
                                                <Lightbulb className="w-4 h-4" /> Hackathons
                                            </TabsTrigger>
                                            <TabsTrigger value="questions" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400 rounded-lg gap-2 flex-shrink-0">
