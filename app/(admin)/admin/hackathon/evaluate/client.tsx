    ...
    const handleSubmit = async (teamId: string) => {
        ...
        try {
            ...
            if (res.error) {
                ...
                const sumScores = Number(scores.idea) + Number(scores.tools) + Number(scores.impact) + Number(scores.sustainability) + Number(scores.feasibility) + Number(scores.communication);
                                                            ...
                                                            <div className="p-6 md:p-8 bg-black/40">
                                                                ...
                                                                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                                                                    <div className="text-2xl font-black text-white">
                                                                        Total: <span className="text-amber-500">{(Number(scores.idea) + Number(scores.tools) + Number(scores.impact) + Number(scores.sustainability) + Number(scores.feasibility) + Number(scores.communication)).toFixed(1)}</span><span className="text-gray-500 text-lg">/30</span>
                                                                    </div>
