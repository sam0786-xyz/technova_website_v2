            ...
            <main className="max-w-md mx-auto space-y-4">
                ...
                <div className="bg-violet-500/10 border border-violet-500/20 rounded-xl p-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full bg-black/60 border border-white/20 rounded-lg px-4 py-2.5 text-white text-sm font-medium appearance-none focus:outline-none focus:border-violet-500 cursor-pointer"
                        >
                            {checkpoints.map(cp => (
                ...
                <div className="flex bg-white/5 p-1 rounded-xl">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-xs font-medium transition-colors ${!showSearch ? 'bg-violet-600 text-white' : 'text-gray-400 hover:text-white'}`}
                    >
                    ...
                    <div className="space-y-3">
                        ...
                        {loadingAttendees ? (
                            <div className="text-center py-6">
                                ...
                                <p className="text-gray-500 text-xs">Loading attendees...</p>
                            </div>
                                        ...
                                        <div key={a.id} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/10">
                                            <div className="flex-1 min-w-0 mr-3">
                                                ...
                                                <div className="flex gap-1 mt-1">
                                                    {checkpoints.map(cp => (
                                                        <span key={cp} className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${hasScannedCheckpoint(a, cp) ? 'bg-emerald-500/20 text-emerald-400' : 'bg-white/5 text-gray-600'}`}>
                                                            {cp}
                                                        </span>
                                                    ))}
                                                </div>
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all disabled:opacity-40 ${alreadyScanned ? 'bg-emerald-600/20 text-emerald-400 cursor-not-allowed' : 'bg-violet-600 hover:bg-violet-500 text-white'}`}
                                            >
